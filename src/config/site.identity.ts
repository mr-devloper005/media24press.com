export const siteIdentity = {
  ...
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Media 24 Press',
  tagline: process.env.NEXT_PUBLIC_SITE_TAGLINE || 'Independent media updates',
  description:
    process.env.NEXT_PUBLIC_SITE_DESCRIPTION ||
    'A simple newsroom-style publication for announcements, coverage, and media updates on Media 24 Press.',
